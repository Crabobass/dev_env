...
# TODO: 
 - [ ] вынести .sh скрипты в отдельную директорию
 - [ ] сделать импорт и экспорт sql 
 - [ ] в корне оставить только один .sh который будет запускать остальные
 - [ ] добавить скрипт разворачивающий чистый инстанс битры (для быстрого старта)
 - [ ] доработать скрипты для бэкапирования (исключить ручную архивацию)
 - [ ] сделать отдельную ветку с версией для нескольких app
# Запуск
